...
public class DedicatedManager
{
    ...
    public void AllowEnterGame(DSC_AllowEnterGame packet, Action callback)
    {
        ...
        foreach (PlayerInfo playerInfo in packet.Players)
        {
            ...
            Managers.Player._otherDediPlayers.Add(dediPlayer.PlayerId,dediPlayer);
        }
