...
class PacketManager
{
	...
	{		
		...
		_onRecv.Add((ushort)MsgId.DscDetectedPlayers, MakePacket<DSC_DetectedPlayers>);
		_handler.Add((ushort)MsgId.DscDetectedPlayers, PacketHandler.DSC_DetectedPlayersHandler);		
